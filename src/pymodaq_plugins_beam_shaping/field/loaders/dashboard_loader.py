...
from pymodaq_plugins_beam_shaping.field.utils import (FieldLoader, LoadTypeEnum,
                                                      Field)
from pymodaq_plugins_beam_shaping.field.factory import LoaderFactory
...
class DashboardLoader(FieldLoader):
    ...
    def load(self, *args, load_type: LoadTypeEnum = None, **kwargs) -> Field:
        ...
        if self.modules_manager is not None:
            ...
            if detector is not None and detector.current_data is not None:
